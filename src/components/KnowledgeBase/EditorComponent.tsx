  ...
  return (
    <>
      <div className="flex justify-between mb-4">
        <input className="input input-ghost input-2xl text-2xl w-full md:w-3/4" placeholder="Title here" value={currentTitle} onChange={(e) => setCurrentTitle(e.currentTarget.value)}/>
        <button type="button" onClick={() => publishPage()} className="fixed bottom-4 left-4 md:relative md:bottom-0 md:left-0 btn btn-primary">Publish</button>
      </div>
