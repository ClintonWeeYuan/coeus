    ...
    <div className="">
      ...
      <div className="px-2 md:px-8">
        ...
        <div className="py-6 mb-8">
          ...
          <div className="flex flex-col overflow-x-auto border-2 border-purple-500">
            {
              slots.map((slot, index) => checkedState[index] && (
                <div key={index} className="h-12 md:h-16 px-2 mb-6 grid grid-cols-12 gap-2 md:gap-4 items-center border-2 border-green-500">
